...
@section('content')
    ...
    <form action="{{route('store.holiday.data',$data['id'])}}" method="post">
        @csrf
        <div class="container">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar">Edit Home Place</h1>
                            ...
                            <div class="panel-body">
                                ...
                                <h3 class="panel-body-title">{{ __('Feature Image')}}</h3>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="@if(!empty($data['position'])) {{$data['position']}}  @endif" placeholder="Ex 1,2" name="position" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>{{ __('Url')}}</label>
